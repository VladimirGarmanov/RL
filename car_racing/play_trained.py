...
def main():
    """Загружает обученную модель и крутит эпизоды с визуализацией.

    Действия выбираются детерминированно (deterministic=True — без
    случайного исследования, только «лучшее» по мнению политики).
    После каждого эпизода печатается причина завершения и статистика.
    """
